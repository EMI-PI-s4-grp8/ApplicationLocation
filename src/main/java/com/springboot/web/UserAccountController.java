...
import com.springboot.repository.UserRepositoryMail;

@Controller
public class UserAccountController {
	
	@Autowired
	private UserRepositoryMail userRepositoryMail;
	...
	// Registration
		...
		public ModelAndView registerUser(ModelAndView modelAndView, User user) {
			...
			User existingUser = userRepositoryMail.findByEmail(user.getEmail());
			if(existingUser != null) {
				modelAndView.addObject("message","This email already exists!");
				modelAndView.setViewName("error");
			} else {
				user.setPassword(encoder.encode(user.getPassword()));
				userRepositoryMail.save(user);
		...
		public ModelAndView confirmUserAccount(ModelAndView modelAndView, @RequestParam("token")String confirmationToken) {
			...
			if(token != null)
			{
				User user = userRepositoryMail.findByEmail(token.getUser().getEmail());
...
//		}
		...
		public ModelAndView forgotUserPassword(ModelAndView modelAndView, User user) {
			...
			if(existingUser != null) {
				...
				mailMessage.setFrom("nairobley@gmail.com");
				mailMessage.setText("-- FinTbat -- To complete the password reset process, please click here: "
		...
		public ModelAndView resetUserPassword(ModelAndView modelAndView, User user) {
			...
			if(user.getEmail() != null) {
				...
				User tokenUser = userRepositoryMail.findByEmail(user.getEmail());
				tokenUser.setEnabled(true);
				tokenUser.setPassword(encoder.encode(user.getPassword()));
				System.out.println(tokenUser.getPassword());
				userRepositoryMail.save(tokenUser);
		...
		public UserRepositoryMail getUserRepository() {
			return userRepositoryMail;
		}
	
		public void setUserRepository(UserRepositoryMail userRepository) {
			this.userRepositoryMail = userRepository;
		}
